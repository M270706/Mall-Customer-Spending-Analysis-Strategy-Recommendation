...
Original file is located at
    https://colab.research.google.com/drive/1b8I340Ar4uPvFHL_JhqWwD_DZVoNcA-s
...
#         st.error("Error: '/content/Mall_Customers.csv' not found. Please ensure the data processing cells have been run and the CSV file is saved.")
#         return pd.DataFrame()
# 
# dataset = load_data()
# 
